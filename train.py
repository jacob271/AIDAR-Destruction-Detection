...
model, val_loss, val_acc = train_model(model, train_destruct_features, train_non_destruct_features, val_destruct,
                                       val_non_destruct, batch=32,
                                       param_epoch=options.epochs)  # ,val_destruct,val_non_destruct,batch=32,param_epoch=options.epochs)
print("Training Done!!!")
